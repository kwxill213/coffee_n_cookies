    ...
    <section className="relative overflow-hidden bg-coffee-100 rounded-lg p-12 shadow-sm mb-16">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className="flex justify-center space-x-4">
          <Button className="px-6 py-3 bg-coffee-500 hover:bg-coffee-600">
            Забронировать стол
          </Button>
          <Button variant="outline" className="px-6 py-3 border-coffee-500 text-coffee-700 hover:bg-coffee-100">
            Посмотреть меню
          </Button>
        </div>
      </div>
